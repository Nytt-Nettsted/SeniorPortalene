<?php
class PP_Non_Portaler_Widget extends WP_Widget {
	...
	public function __construct() {
		$src = true;
		$sites = pp_sites( $src );
		$text = 'våre øvrige nettsteder';
//		parent::__construct( 'pp-non-portaler-widget', 'Besøk ' . ( is_null( $sites[ get_current_blog_id() ] ) ?  $sites[1]->blogname : $text ), array( 'description' => 'Lenker til ' . $text ) );
		parent::__construct( 'pp-non-portaler-widget', 'Besøk BPA-portalen', array( 'description' => 'Lenker til ' . $text ) );
	}
	...
	public function widget( $args, $instance ) {
		// outputs the content of the widget
		$src = true;	// Finn alle merket mature
